%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%UDP flood - LDA only as previous work
%
%
%Author : 
%Date Created : 
...
saveas(gcf, 'results\data_UDP+LDA.jpg');
...
indx=randperm(N,2);
temp=attkmatrx(indx);
attkmatrx(1,indx) = xor(temp,temp);
attkmatrx(2,indx) = ~temp;
...
plotperform(tr);
saveas(gcf, 'results\perf_UDP+LDA.jpg');
plottrainstate(tr);
saveas(gcf, 'results\trstate_UDP+LDA.jpg');

%Plotting
figure
plotconfusion(testT,testY);
saveas(gcf, 'results\confusion_UDP+LDA.jpg');
figure
plotroc(testT,testY);
saveas(gcf, 'results\roc_UDP+LDA.jpg')
...
title('Errors Plot');
saveas(gcf, 'results\errplot_UDP+LDA.jpg');
...
fid0=fopen('scores_UDP+LDA.txt','w');
